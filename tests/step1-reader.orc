...
instr TEST
  ...
  ASSERT_REP("abc", "abc")
  ASSERT_REP("abc ", "abc")
  ASSERT_REP("1abc", "1abc")
  ASSERT_REP("-abc", "-abc")
  ASSERT_REP("->>", "->>")
  Stab = sprintf("%c", $MAL_TAB_TOKEN)
  ASSERT_REP(sprintf("%sabc%s", Stab, Stab), "abc")
  ASSERT_REP("", "nil")
  ASSERT_REP("   ", "nil")
  ASSERT_REP(Stab, "nil")
  ASSERT_REP("; comment only", "nil")
  ASSERT_REP("  ; comment only", "nil")
  ASSERT_REP("1 ; comment after expression", "1")
  ASSERT_REP("1; comment after expression", "1")
  ASSERT_REP("-", "-")
  ...
  ASSERT_REP(sprintf("(%s1%s2%s3%s)", Stab, Stab, Stab, Stab), "(1 2 3)")
  ...
  ASSERT_REP("{}", "{}")
  ASSERT_REP("{ }", "{}")
  ASSERT_REP("{\"abc\" 1}", "{\"abc\" 1}")
  ASSERT_REP("{\"a\" {\"b\" 2}}", "{\"a\" {\"b\" 2}}")
  ASSERT_REP("{:a {:b 2}}", "{:a {:b 2}}")
  ASSERT_REP("({})", "({})")
  ASSERT_REP("(1 -2 3)", "(1 -2 3)")
